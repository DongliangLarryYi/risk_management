# Value-at-Risk Computed Using Various Methods
...
#Value at Risk (VaR) with historical simulation method
for (i in 1:246)
{
...
#Value at Risk (VaR) with delta-normal method 
...
#Value at Risk (VaR) with delta-normal method using the exponentially weighted covariance estimator
...
#Value at Risk (VaR) with historical simulation using rescalled returns
...
# calculate volatility which will be used to rescale returns
for (i in 1:2247)
{
